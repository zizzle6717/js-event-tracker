...
describe('quickSearch', () => {
    ...
    it('returns value index when searchVal is found in array', () => {
        ...
        const expecte3 = 8;
        expect(actua3).to.be.equal(expecte3);
    });
    ...
    it('throws if arrSortIndex is invalid', () => {
        ...
        const expected = 'typeof arrSortVal and searchVal are required to match (found object and number)';
        ...
        const expected3 = 'typeof arrSortVal and searchVal are required to match (found string and number)';
